...
wf_name="CellRangerCellPlex"
version="6.0.2"
files="submit.sh CellRangerCellPlex.deps.zip CellRangerCellPlex.wdl CellRangerCellPlex.options.aws.json CellRangerCellPlex.options.aws.json"
dest="$HOME/scing/bin"
